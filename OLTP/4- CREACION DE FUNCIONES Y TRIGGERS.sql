...
-- TRIGGER BEFORE INSERT, PARA GENERAR EL CODIGO DE ATENCION SIGUIENDO EL FORMATO: AT-{CLINICA}-{YYYYMMDD}-{SEQ}
...
-- PARA HACER PRUEBAS NO MONTAMOS ESTE TRIGGER YA QUE CREAMOS REGISTROS HASTA DICIEMBRE 2025
