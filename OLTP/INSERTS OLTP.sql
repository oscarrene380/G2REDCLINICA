...
* TABLA SERVICIOS
*/
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('CONS-001', 'Consulta General', 1, NULL, 50.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('LAB-001', 'Hemograma Completo', 2, NULL, 30.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('IMG-001', 'Rayos X de Tórax', 3, NULL, 75.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('HOSP-001', 'Hospitalización por Día', 4, NULL, 200.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
...
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('TER-001', 'Sesión de Fisioterapia', 7, NULL, 60.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('URG-001', 'Atención en Urgencias', 8, NULL, 120.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('ODON-001', 'Limpieza Dental', 9, NULL, 80.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('PSIC-001', 'Consulta Psicológica', 10, NULL, 70.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('VAC-001', 'Vacuna Antigripal', 11, NULL, 25.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('NUTRI-001', 'Consulta Nutricional', 12, NULL, 55.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
...
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('EXAM-002', 'Resonancia Magnética (RM)', 5, NULL, 500.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('LAB-002', 'Prueba de Función Hepática', 2, NULL, 45.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
INSERT INTO trx_servicios (codigo_estandar, descripcion, id_tipo_servicio, id_especialidad, precio_unitario, vigencia_inicio, vigencia_fin) VALUES ('IMG-002', 'Ultrasonido Abdominal', 3, NULL, 120.00, TO_DATE('2025-01-01','YYYY-MM-DD'), NULL);
